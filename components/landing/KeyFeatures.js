  ...
  const features = [
    {
      ...
      description: "Pool global compute resources to train models faster and more efficiently."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Community-driven model selection, funding, and roadmap planning."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Earn DAO tokens or payments for contributed compute and expertise."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Automated job scheduling, reward distribution, and progress tracking on-chain."
    }
  ];
